...
export class Settings implements OnInit {
  ...
  ngOnInit() {
    this.apiUrl = localStorage.getItem('__PERSONAL_ASSISTANT_API_URL__') ?? ''
  ...
  clearApiUrl() {
    this.apiUrl = ''
    localStorage.removeItem('__PERSONAL_ASSISTANT_API_URL__')
  }
  ...
  save() {
    if (this.apiUrl.trim()) {
      localStorage.setItem('__PERSONAL_ASSISTANT_API_URL__', this.apiUrl.trim())
    } else {
      localStorage.removeItem('__PERSONAL_ASSISTANT_API_URL__')
    }
