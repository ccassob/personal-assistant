...
import { ChoiceSelectInputDirective } from '@/app/core/directive/choices-select.directive'
...
@Component({
  selector: 'app-select',
  imports: [PageBreadcrumb, ChoiceSelectInputDirective, FormsModule, Select2, Icon, NgbAlert],
