      ...
      data: [
        {
          ...
          areaStyle: {
            color: getColor('chart-primary-rgb', 0.5), // Blueish transparent
          },
          lineStyle: {
            color: getColor('chart-primary-rgb', 0.5),
          },
          itemStyle: {
        ...
        },
        {
          ...
          areaStyle: {
            color: getColor('chart-secondary-rgb', 0.5), // Blueish transparent
          },
          lineStyle: {
            color: getColor('chart-secondary-rgb', 0.5), // Blueish transparent
          },
        ...
        },
        {
          ...
          areaStyle: {
            color: new echarts.graphic.RadialGradient(0.1, 0.6, 1, [
              {
                color: getColor('chart-primary-rgb', 0.1),
                offset: 0,
              },
              {
                color: getColor('chart-primary-rgb', 0.7),
                offset: 1,
              },
            ]),
          },
