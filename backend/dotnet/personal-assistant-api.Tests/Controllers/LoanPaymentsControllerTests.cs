...
public class LoanPaymentsControllerTests : IClassFixture<PersonalAssistantApiFactory>
{
    private readonly HttpClient _client;
    private readonly PersonalAssistantApiFactory _factory;

    public LoanPaymentsControllerTests(PersonalAssistantApiFactory factory)
    {
        _factory = factory;
    ...
    private static Loan SeedLoan(PersonalAssistantApiFactory factory, string name = "Test Loan") =>
        new()
        {
